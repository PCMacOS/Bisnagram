...
import psmakos.com.businagram.materialcamera.util.Degrees;
import psmakos.com.businagram.materialcamera.util.ImageUtil;
import psmakos.com.businagram.materialcamera.util.ManufacturerUtil;

import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static psmakos.com.businagram.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  psmakos.com.businagram.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new psmakos.com.businagram.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof psmakos.com.businagram.materialcamera.internal.CameraPreview)
