...
import psmakos.com.businagram.easyvideoplayer.EasyVideoCallback;
import psmakos.com.businagram.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(psmakos.com.businagram.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(psmakos.com.businagram.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(psmakos.com.businagram.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
